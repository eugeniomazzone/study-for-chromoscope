...
do
	...
	echo id: "'"$SAMPLE"'",
        ...
        echo sv: "'"https://raw.githubusercontent.com/eugeniomazzone/study-for-chromoscope/refs/heads/main/StoreSample/$SAMPLE-SV.txt"'",
        echo cnv: "'"https://raw.githubusercontent.com/eugeniomazzone/study-for-chromoscope/refs/heads/main/StoreSample/$SAMPLE-TCN.txt"'",
        echo note: "'"$SAMPLE"'"
    echo },
